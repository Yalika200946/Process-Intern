...
2026-07-17, was 16_cleaning_plan_optimization.ipynb) from cell definitions.
...
out_path = Path(__file__).resolve().parent / 'production' / '13_cleaning_plan_optimization.ipynb'
