...
def _config():
    return {"aliases":{"FLOW":"flow.pv"},"rules":{"flow_min_m3_h":15.0,"cold_delta_t_min_c":3.0,"hot_delta_t_min_c":2.0,"terminal_delta_t_min_c":2.0,"temperature_min_c":0.0,"temperature_max_c":450.0,"startup_records":2,"steady_flow_relative_change_max":0.10,"steady_temperature_change_max_c":5.0}}
